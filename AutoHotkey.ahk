...
;		Return 1
	...
	IfWinActive, ahk_class OpusApp
		Return 1
;	IfWinActive,ahk_class Vim ;Windowsè„ÇÃGVIM
;		Return 1
...
sc07B & 4::
	...
	{
		DetectHiddenWindows, On
		Run,"C:\Progra~1\Internet Explorer\iexplore.exe"
	}
	Return
#7::
sc07B & 7::
	...
	Else
		Run,"D:\bin\dyna214\dynaclient.exe"
	Return
#8::
sc07B & 8::
...
sc07B & 0::
	...
	Else
		Run C:\cygwin\bin\mintty.exe -i '/Cygwin-Terminal.ico' -t Mintty /bin/zsh.exe --login -c 'screen'
	Return
